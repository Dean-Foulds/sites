<?php
/* WURKPRESS Custom Post Type Example
...
function custom_post_appeals() {
	// creating (registering) the custom type 
	register_post_type( 'appeals', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Appeals', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Appeal', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Appeals', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Appeal', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Appeal', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Appeal', 'jointswp'), /* New Display Title */
			'view_item' => __('View Appeal', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Appeal', 'jointswp'), /* Search Custom Type Title */
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Section for creating new appeals on SPANA', 'jointswp' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'appeals', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'appeals', /* you can rename the slug here */
...
//	register_taxonomy_for_object_type('post_tag', 'custom_type');
	...
	add_action( 'init', 'custom_post_appeals');
