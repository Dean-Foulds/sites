...
function joints_rss_dashboard_widget() {
	if(function_exists('fetch_feed')) {
		...
		$feed = fetch_feed('http://www.wurkhouse.com/feed/rss/');        // specify the source feed
...
function joints_custom_dashboard_widgets() {
	wp_add_dashboard_widget('joints_rss_dashboard_widget', __('Wurkhouse Blog & News', 'jointswp'), 'joints_rss_dashboard_widget');
	/*
...
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Powered by <a href="http://www.wurkhouse.com" target="_blank">WURKHOUSE</a></span>.', 'jointswp');
}
